...
void register_Name_class(){
    ...
    { //::SireID::Name
        ...
        Name_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::Name >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Name_exposer.def( "__getstate_manages_dict__", true);
        Name_exposer.def( "__safe_for_unpickling__", true);
        Name_exposer.def( "__setstate__", &__setstate__base64< ::SireID::Name > );
        Name_exposer.def( "__getstate__", &__getstate__base64< ::SireID::Name > );
