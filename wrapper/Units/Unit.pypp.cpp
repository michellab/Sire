...
void register_Unit_class(){
    ...
    { //::SireUnits::Dimension::Unit
        ...
        Unit_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireUnits::Dimension::Unit >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Unit_exposer.def( "__getstate_manages_dict__", true);
        Unit_exposer.def( "__safe_for_unpickling__", true);
        Unit_exposer.def( "__setstate__", &__setstate__base64< ::SireUnits::Dimension::Unit > );
        Unit_exposer.def( "__getstate__", &__getstate__base64< ::SireUnits::Dimension::Unit > );
