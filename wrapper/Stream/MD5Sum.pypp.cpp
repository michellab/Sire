...
void register_MD5Sum_class(){
    ...
    { //::SireStream::MD5Sum
        ...
        MD5Sum_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireStream::MD5Sum >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MD5Sum_exposer.def( "__getstate_manages_dict__", true);
        MD5Sum_exposer.def( "__safe_for_unpickling__", true);
        MD5Sum_exposer.def( "__setstate__", &__setstate__base64< ::SireStream::MD5Sum > );
        MD5Sum_exposer.def( "__getstate__", &__getstate__base64< ::SireStream::MD5Sum > );
