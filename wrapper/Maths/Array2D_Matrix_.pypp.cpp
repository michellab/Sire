...
void register_Array2D_Matrix__class(){
    ...
    { //::SireBase::Array2D< SireMaths::Matrix >
        ...
        Array2D_Matrix__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::Array2D<SireMaths::Matrix> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Array2D_Matrix__exposer.def( "__getstate_manages_dict__", true);
        Array2D_Matrix__exposer.def( "__safe_for_unpickling__", true);
        Array2D_Matrix__exposer.def( "__setstate__", &__setstate__base64< ::SireBase::Array2D<SireMaths::Matrix> > );
        Array2D_Matrix__exposer.def( "__getstate__", &__getstate__base64< ::SireBase::Array2D<SireMaths::Matrix> > );
