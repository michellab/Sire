...
void register_Matrix_class(){
    ...
    { //::SireMaths::Matrix
        ...
        Matrix_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Matrix >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Matrix_exposer.def( "__getstate_manages_dict__", true);
        Matrix_exposer.def( "__safe_for_unpickling__", true);
        Matrix_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::Matrix > );
        Matrix_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::Matrix > );
