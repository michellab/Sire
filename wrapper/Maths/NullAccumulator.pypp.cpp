...
void register_NullAccumulator_class(){
    ...
    { //::SireMaths::NullAccumulator
        ...
        NullAccumulator_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::NullAccumulator >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullAccumulator_exposer.def( "__getstate_manages_dict__", true);
        NullAccumulator_exposer.def( "__safe_for_unpickling__", true);
        NullAccumulator_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::NullAccumulator > );
        NullAccumulator_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::NullAccumulator > );
