...
void register_Line_class(){
    ...
    { //::SireMaths::Line
        ...
        Line_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Line >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Line_exposer.def( "__getstate_manages_dict__", true);
        Line_exposer.def( "__safe_for_unpickling__", true);
        Line_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::Line > );
        Line_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::Line > );
