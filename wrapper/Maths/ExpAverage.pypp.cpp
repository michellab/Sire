...
void register_ExpAverage_class(){
    ...
    { //::SireMaths::ExpAverage
        ...
        ExpAverage_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::ExpAverage >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ExpAverage_exposer.def( "__getstate_manages_dict__", true);
        ExpAverage_exposer.def( "__safe_for_unpickling__", true);
        ExpAverage_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::ExpAverage > );
        ExpAverage_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::ExpAverage > );
