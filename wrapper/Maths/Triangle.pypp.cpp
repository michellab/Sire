...
void register_Triangle_class(){
    ...
    { //::SireMaths::Triangle
        ...
        Triangle_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Triangle >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Triangle_exposer.def( "__getstate_manages_dict__", true);
        Triangle_exposer.def( "__safe_for_unpickling__", true);
        Triangle_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::Triangle > );
        Triangle_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::Triangle > );
