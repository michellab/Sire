...
void register_AxisSet_class(){
    ...
    { //::SireMaths::AxisSet
        ...
        AxisSet_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::AxisSet >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AxisSet_exposer.def( "__getstate_manages_dict__", true);
        AxisSet_exposer.def( "__safe_for_unpickling__", true);
        AxisSet_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::AxisSet > );
        AxisSet_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::AxisSet > );
