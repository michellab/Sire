...
void register_TrigArray2D_Matrix__class(){
    ...
    { //::SireBase::TrigArray2D< SireMaths::Matrix >
        ...
        TrigArray2D_Matrix__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::TrigArray2D<SireMaths::Matrix> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TrigArray2D_Matrix__exposer.def( "__getstate_manages_dict__", true);
        TrigArray2D_Matrix__exposer.def( "__safe_for_unpickling__", true);
        TrigArray2D_Matrix__exposer.def( "__setstate__", &__setstate__base64< ::SireBase::TrigArray2D<SireMaths::Matrix> > );
        TrigArray2D_Matrix__exposer.def( "__getstate__", &__getstate__base64< ::SireBase::TrigArray2D<SireMaths::Matrix> > );
