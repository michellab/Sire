...
void register_Sphere_class(){
    ...
    { //::SireMaths::Sphere
        ...
        Sphere_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Sphere >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Sphere_exposer.def( "__getstate_manages_dict__", true);
        Sphere_exposer.def( "__safe_for_unpickling__", true);
        Sphere_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::Sphere > );
        Sphere_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::Sphere > );
