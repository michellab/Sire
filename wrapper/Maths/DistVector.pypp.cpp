...
void register_DistVector_class(){
    ...
    { //::SireMaths::DistVector
        ...
        DistVector_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::DistVector >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        DistVector_exposer.def( "__getstate_manages_dict__", true);
        DistVector_exposer.def( "__safe_for_unpickling__", true);
        DistVector_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::DistVector > );
        DistVector_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::DistVector > );
