...
void register_AmberRst7_class(){
    ...
    { //::SireIO::AmberRst7
        ...
        AmberRst7_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::AmberRst7 >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AmberRst7_exposer.def( "__getstate_manages_dict__", true);
        AmberRst7_exposer.def( "__safe_for_unpickling__", true);
        AmberRst7_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::AmberRst7 > );
        AmberRst7_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::AmberRst7 > );
