...
void register_Mol2_class(){
    ...
    { //::SireIO::Mol2
        ...
        Mol2_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::Mol2 >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Mol2_exposer.def( "__getstate_manages_dict__", true);
        Mol2_exposer.def( "__safe_for_unpickling__", true);
        Mol2_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::Mol2 > );
        Mol2_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::Mol2 > );
