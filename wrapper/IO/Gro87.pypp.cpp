...
void register_Gro87_class(){
    ...
    { //::SireIO::Gro87
        ...
        Gro87_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::Gro87 >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Gro87_exposer.def( "__getstate_manages_dict__", true);
        Gro87_exposer.def( "__safe_for_unpickling__", true);
        Gro87_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::Gro87 > );
        Gro87_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::Gro87 > );
