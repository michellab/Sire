...
void register_NullParser_class(){
    ...
    { //::SireIO::NullParser
        ...
        NullParser_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::NullParser >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullParser_exposer.def( "__getstate_manages_dict__", true);
        NullParser_exposer.def( "__safe_for_unpickling__", true);
        NullParser_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::NullParser > );
        NullParser_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::NullParser > );
