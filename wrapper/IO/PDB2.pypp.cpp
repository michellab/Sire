...
void register_PDB2_class(){
    ...
    { //::SireIO::PDB2
        ...
        PDB2_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::PDB2 >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PDB2_exposer.def( "__getstate_manages_dict__", true);
        PDB2_exposer.def( "__safe_for_unpickling__", true);
        PDB2_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::PDB2 > );
        PDB2_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::PDB2 > );
