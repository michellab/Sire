...
void register_Amber_class(){
    ...
    { //::SireIO::Amber
        ...
        Amber_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::Amber >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Amber_exposer.def( "__getstate_manages_dict__", true);
        Amber_exposer.def( "__safe_for_unpickling__", true);
        Amber_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::Amber > );
        Amber_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::Amber > );
