...
void register_PDB_class(){
    ...
    { //::SireIO::PDB
        ...
        PDB_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::PDB >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PDB_exposer.def( "__getstate_manages_dict__", true);
        PDB_exposer.def( "__safe_for_unpickling__", true);
        PDB_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::PDB > );
        PDB_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::PDB > );
