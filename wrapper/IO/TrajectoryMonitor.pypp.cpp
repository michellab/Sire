...
void register_TrajectoryMonitor_class(){
    ...
    { //::SireIO::TrajectoryMonitor
        ...
        TrajectoryMonitor_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::TrajectoryMonitor >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TrajectoryMonitor_exposer.def( "__getstate_manages_dict__", true);
        TrajectoryMonitor_exposer.def( "__safe_for_unpickling__", true);
        TrajectoryMonitor_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::TrajectoryMonitor > );
        TrajectoryMonitor_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::TrajectoryMonitor > );
