...
void register_FlexibilityTemplate_class(){
    ...
    { //::SireIO::FlexibilityTemplate
        ...
        FlexibilityTemplate_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::FlexibilityTemplate >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        FlexibilityTemplate_exposer.def( "__getstate_manages_dict__", true);
        FlexibilityTemplate_exposer.def( "__safe_for_unpickling__", true);
        FlexibilityTemplate_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::FlexibilityTemplate > );
        FlexibilityTemplate_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::FlexibilityTemplate > );
