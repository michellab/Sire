...
void register_AmberPrm_class(){
    ...
    { //::SireIO::AmberPrm
        ...
        AmberPrm_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireIO::AmberPrm >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AmberPrm_exposer.def( "__getstate_manages_dict__", true);
        AmberPrm_exposer.def( "__safe_for_unpickling__", true);
        AmberPrm_exposer.def( "__setstate__", &__setstate__base64< ::SireIO::AmberPrm > );
        AmberPrm_exposer.def( "__getstate__", &__getstate__base64< ::SireIO::AmberPrm > );
