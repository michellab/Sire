...
void register_System_class(){
    ...
    { //::SireSystem::System
        ...
        System_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::System >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        System_exposer.def( "__getstate_manages_dict__", true);
        System_exposer.def( "__safe_for_unpickling__", true);
        System_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::System > );
        System_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::System > );
