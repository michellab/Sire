...
void register_GeometryComponent_class(){
    ...
    { //::SireSystem::GeometryComponent
        ...
        GeometryComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::GeometryComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GeometryComponent_exposer.def( "__getstate_manages_dict__", true);
        GeometryComponent_exposer.def( "__safe_for_unpickling__", true);
        GeometryComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::GeometryComponent > );
        GeometryComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::GeometryComponent > );
