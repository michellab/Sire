...
void register_IDOrSet_SysID__class(){
    ...
    { //::SireID::IDOrSet< SireSystem::SysID >
        ...
        IDOrSet_SysID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::IDOrSet<SireSystem::SysID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        IDOrSet_SysID__exposer.def( "__getstate_manages_dict__", true);
        IDOrSet_SysID__exposer.def( "__safe_for_unpickling__", true);
        IDOrSet_SysID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::IDOrSet<SireSystem::SysID> > );
        IDOrSet_SysID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::IDOrSet<SireSystem::SysID> > );
