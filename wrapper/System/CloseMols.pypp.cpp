...
void register_CloseMols_class(){
    ...
    { //::SireSystem::CloseMols
        ...
        CloseMols_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::CloseMols >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CloseMols_exposer.def( "__getstate_manages_dict__", true);
        CloseMols_exposer.def( "__safe_for_unpickling__", true);
        CloseMols_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::CloseMols > );
        CloseMols_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::CloseMols > );
