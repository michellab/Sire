...
void register_SysIdx_class(){
    ...
    { //::SireSystem::SysIdx
        ...
        SysIdx_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::SysIdx >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SysIdx_exposer.def( "__getstate_manages_dict__", true);
        SysIdx_exposer.def( "__safe_for_unpickling__", true);
        SysIdx_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::SysIdx > );
        SysIdx_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::SysIdx > );
