...
void register_FreeEnergyMonitor_class(){
    ...
    { //::SireSystem::FreeEnergyMonitor
        ...
        FreeEnergyMonitor_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::FreeEnergyMonitor >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        FreeEnergyMonitor_exposer.def( "__getstate_manages_dict__", true);
        FreeEnergyMonitor_exposer.def( "__safe_for_unpickling__", true);
        FreeEnergyMonitor_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::FreeEnergyMonitor > );
        FreeEnergyMonitor_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::FreeEnergyMonitor > );
