...
void register_PropertyConstraint_class(){
    ...
    { //::SireSystem::PropertyConstraint
        ...
        PropertyConstraint_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::PropertyConstraint >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PropertyConstraint_exposer.def( "__getstate_manages_dict__", true);
        PropertyConstraint_exposer.def( "__safe_for_unpickling__", true);
        PropertyConstraint_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::PropertyConstraint > );
        PropertyConstraint_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::PropertyConstraint > );
