...
void register_DihedralComponent_class(){
    ...
    { //::SireSystem::DihedralComponent
        ...
        DihedralComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::DihedralComponent > );
        DihedralComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::DihedralComponent > );
