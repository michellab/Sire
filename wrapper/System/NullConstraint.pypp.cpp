...
void register_NullConstraint_class(){
    ...
    { //::SireSystem::NullConstraint
        ...
        NullConstraint_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::NullConstraint >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullConstraint_exposer.def( "__getstate_manages_dict__", true);
        NullConstraint_exposer.def( "__safe_for_unpickling__", true);
        NullConstraint_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::NullConstraint > );
        NullConstraint_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::NullConstraint > );
