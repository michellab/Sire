...
void register_AssignerGroup_class(){
    ...
    { //::SireSystem::AssignerGroup
        ...
        AssignerGroup_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::AssignerGroup >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AssignerGroup_exposer.def( "__getstate_manages_dict__", true);
        AssignerGroup_exposer.def( "__safe_for_unpickling__", true);
        AssignerGroup_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::AssignerGroup > );
        AssignerGroup_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::AssignerGroup > );
