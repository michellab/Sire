...
void register_ComponentConstraint_class(){
    ...
    { //::SireSystem::ComponentConstraint
        ...
        ComponentConstraint_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::ComponentConstraint >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ComponentConstraint_exposer.def( "__getstate_manages_dict__", true);
        ComponentConstraint_exposer.def( "__safe_for_unpickling__", true);
        ComponentConstraint_exposer.def( "__setstate__", &__setstate__base64< ::SireSystem::ComponentConstraint > );
        ComponentConstraint_exposer.def( "__getstate__", &__getstate__base64< ::SireSystem::ComponentConstraint > );
