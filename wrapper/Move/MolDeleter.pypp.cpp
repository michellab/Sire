...
void register_MolDeleter_class(){
    ...
    { //::SireMove::MolDeleter
        ...
        MolDeleter_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::MolDeleter >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MolDeleter_exposer.def( "__getstate_manages_dict__", true);
        MolDeleter_exposer.def( "__safe_for_unpickling__", true);
        MolDeleter_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::MolDeleter > );
        MolDeleter_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::MolDeleter > );
