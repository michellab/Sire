...
void register_NullSupraMove_class(){
    ...
    { //::SireMove::NullSupraMove
        ...
        NullSupraMove_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::NullSupraMove >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullSupraMove_exposer.def( "__getstate_manages_dict__", true);
        NullSupraMove_exposer.def( "__safe_for_unpickling__", true);
        NullSupraMove_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::NullSupraMove > );
        NullSupraMove_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::NullSupraMove > );
