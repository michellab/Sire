...
void register_OpenMMMDIntegrator_class(){
    ...
    { //::SireMove::OpenMMMDIntegrator
        ...
        OpenMMMDIntegrator_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::OpenMMMDIntegrator >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        OpenMMMDIntegrator_exposer.def( "__getstate_manages_dict__", true);
        OpenMMMDIntegrator_exposer.def( "__safe_for_unpickling__", true);
        OpenMMMDIntegrator_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::OpenMMMDIntegrator > );
        OpenMMMDIntegrator_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::OpenMMMDIntegrator > );
