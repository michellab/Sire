...
void register_RepExMove_class(){
    ...
    { //::SireMove::RepExMove
        ...
        RepExMove_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::RepExMove >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        RepExMove_exposer.def( "__getstate_manages_dict__", true);
        RepExMove_exposer.def( "__safe_for_unpickling__", true);
        RepExMove_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::RepExMove > );
        RepExMove_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::RepExMove > );
