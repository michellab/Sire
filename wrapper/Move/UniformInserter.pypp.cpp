...
void register_UniformInserter_class(){
    ...
    { //::SireMove::UniformInserter
        ...
        UniformInserter_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::UniformInserter >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        UniformInserter_exposer.def( "__getstate_manages_dict__", true);
        UniformInserter_exposer.def( "__safe_for_unpickling__", true);
        UniformInserter_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::UniformInserter > );
        UniformInserter_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::UniformInserter > );
