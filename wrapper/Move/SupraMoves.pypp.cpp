...
void register_SupraMoves_class(){
    ...
    { //::SireMove::SupraMoves
        ...
        SupraMoves_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::SupraMoves >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SupraMoves_exposer.def( "__getstate_manages_dict__", true);
        SupraMoves_exposer.def( "__safe_for_unpickling__", true);
        SupraMoves_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::SupraMoves > );
        SupraMoves_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::SupraMoves > );
