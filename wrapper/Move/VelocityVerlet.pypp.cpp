...
void register_VelocityVerlet_class(){
    ...
    { //::SireMove::VelocityVerlet
        ...
        VelocityVerlet_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::VelocityVerlet >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        VelocityVerlet_exposer.def( "__getstate_manages_dict__", true);
        VelocityVerlet_exposer.def( "__safe_for_unpickling__", true);
        VelocityVerlet_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::VelocityVerlet > );
        VelocityVerlet_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::VelocityVerlet > );
