...
void register_TitrationMove_class(){
    ...
    { //::SireMove::TitrationMove
        ...
        TitrationMove_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::TitrationMove >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TitrationMove_exposer.def( "__getstate_manages_dict__", true);
        TitrationMove_exposer.def( "__safe_for_unpickling__", true);
        TitrationMove_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::TitrationMove > );
        TitrationMove_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::TitrationMove > );
