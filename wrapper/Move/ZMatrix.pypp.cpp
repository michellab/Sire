...
void register_ZMatrix_class(){
    ...
    { //::SireMove::ZMatrix
        ...
        ZMatrix_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::ZMatrix >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ZMatrix_exposer.def( "__getstate_manages_dict__", true);
        ZMatrix_exposer.def( "__safe_for_unpickling__", true);
        ZMatrix_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::ZMatrix > );
        ZMatrix_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::ZMatrix > );
