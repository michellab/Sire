...
void register_DLMRigidBody_class(){
    ...
    { //::SireMove::DLMRigidBody
        ...
        DLMRigidBody_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::DLMRigidBody >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        DLMRigidBody_exposer.def( "__getstate_manages_dict__", true);
        DLMRigidBody_exposer.def( "__safe_for_unpickling__", true);
        DLMRigidBody_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::DLMRigidBody > );
        DLMRigidBody_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::DLMRigidBody > );
