...
void register_Replicas_class(){
    ...
    { //::SireMove::Replicas
        ...
        Replicas_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::Replicas >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Replicas_exposer.def( "__getstate_manages_dict__", true);
        Replicas_exposer.def( "__safe_for_unpickling__", true);
        Replicas_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::Replicas > );
        Replicas_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::Replicas > );
