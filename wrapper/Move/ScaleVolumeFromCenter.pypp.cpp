...
void register_ScaleVolumeFromCenter_class(){
    ...
    { //::SireMove::ScaleVolumeFromCenter
        ...
        ScaleVolumeFromCenter_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::ScaleVolumeFromCenter >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ScaleVolumeFromCenter_exposer.def( "__getstate_manages_dict__", true);
        ScaleVolumeFromCenter_exposer.def( "__safe_for_unpickling__", true);
        ScaleVolumeFromCenter_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::ScaleVolumeFromCenter > );
        ScaleVolumeFromCenter_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::ScaleVolumeFromCenter > );
