...
void register_WeightedMoves_class(){
    ...
    { //::SireMove::WeightedMoves
        ...
        WeightedMoves_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMove::WeightedMoves >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        WeightedMoves_exposer.def( "__getstate_manages_dict__", true);
        WeightedMoves_exposer.def( "__safe_for_unpickling__", true);
        WeightedMoves_exposer.def( "__setstate__", &__setstate__base64< ::SireMove::WeightedMoves > );
        WeightedMoves_exposer.def( "__getstate__", &__getstate__base64< ::SireMove::WeightedMoves > );
