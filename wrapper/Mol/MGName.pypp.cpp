...
void register_MGName_class(){
    ...
    { //::SireMol::MGName
        ...
        MGName_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::MGName >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MGName_exposer.def( "__getstate_manages_dict__", true);
        MGName_exposer.def( "__safe_for_unpickling__", true);
        MGName_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::MGName > );
        MGName_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::MGName > );
