...
void register_ConnectivityEditor_class(){
    ...
    { //::SireMol::ConnectivityEditor
        ...
        ConnectivityEditor_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ConnectivityEditor >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ConnectivityEditor_exposer.def( "__getstate_manages_dict__", true);
        ConnectivityEditor_exposer.def( "__safe_for_unpickling__", true);
        ConnectivityEditor_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ConnectivityEditor > );
        ConnectivityEditor_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ConnectivityEditor > );
