...
void register_IDAndSet_ChainID__class(){
    ...
    { //::SireID::IDAndSet< SireMol::ChainID >
        ...
        IDAndSet_ChainID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::IDAndSet<SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        IDAndSet_ChainID__exposer.def( "__getstate_manages_dict__", true);
        IDAndSet_ChainID__exposer.def( "__safe_for_unpickling__", true);
        IDAndSet_ChainID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::IDAndSet<SireMol::ChainID> > );
        IDAndSet_ChainID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::IDAndSet<SireMol::ChainID> > );
