...
void register_Within_class(){
    ...
    { //::SireMol::Within
        ...
        Within_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::Within >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Within_exposer.def( "__getstate_manages_dict__", true);
        Within_exposer.def( "__safe_for_unpickling__", true);
        Within_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::Within > );
        Within_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::Within > );
