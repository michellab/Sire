...
void register_ResVariantProperty_class(){
    ...
    { //::SireMol::ResProperty< QVariant >
        ...
        ResVariantProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ResProperty<QVariant> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResVariantProperty_exposer.def( "__getstate_manages_dict__", true);
        ResVariantProperty_exposer.def( "__safe_for_unpickling__", true);
        ResVariantProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ResProperty<QVariant> > );
        ResVariantProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ResProperty<QVariant> > );
