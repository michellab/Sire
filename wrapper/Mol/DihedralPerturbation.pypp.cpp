...
void register_DihedralPerturbation_class(){
    ...
    { //::SireMol::DihedralPerturbation
        ...
        DihedralPerturbation_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::DihedralPerturbation >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        DihedralPerturbation_exposer.def( "__getstate_manages_dict__", true);
        DihedralPerturbation_exposer.def( "__safe_for_unpickling__", true);
        DihedralPerturbation_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::DihedralPerturbation > );
        DihedralPerturbation_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::DihedralPerturbation > );
