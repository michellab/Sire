...
void register_InvertMatch_ChainID__class(){
    ...
    { //::SireID::InvertMatch< SireMol::ChainID >
        ...
        InvertMatch_ChainID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::InvertMatch<SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InvertMatch_ChainID__exposer.def( "__getstate_manages_dict__", true);
        InvertMatch_ChainID__exposer.def( "__safe_for_unpickling__", true);
        InvertMatch_ChainID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::InvertMatch<SireMol::ChainID> > );
        InvertMatch_ChainID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::InvertMatch<SireMol::ChainID> > );
