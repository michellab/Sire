...
void register_ChainVariantProperty_class(){
    ...
    { //::SireMol::ChainProperty< QVariant >
        ...
        ChainVariantProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ChainProperty<QVariant> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ChainVariantProperty_exposer.def( "__getstate_manages_dict__", true);
        ChainVariantProperty_exposer.def( "__safe_for_unpickling__", true);
        ChainVariantProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ChainProperty<QVariant> > );
        ChainVariantProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ChainProperty<QVariant> > );
