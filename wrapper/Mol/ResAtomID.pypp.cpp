...
void register_ResAtomID_class(){
    ...
    { //::SireMol::GroupAtomID< SireMol::ResID, SireMol::AtomID >
        ...
        ResAtomID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupAtomID<SireMol::ResID, SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResAtomID_exposer.def( "__getstate_manages_dict__", true);
        ResAtomID_exposer.def( "__safe_for_unpickling__", true);
        ResAtomID_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::GroupAtomID<SireMol::ResID, SireMol::AtomID> > );
        ResAtomID_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::GroupAtomID<SireMol::ResID, SireMol::AtomID> > );
