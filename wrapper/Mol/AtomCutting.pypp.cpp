...
void register_AtomCutting_class(){
    ...
    { //::SireMol::AtomCutting
        ...
        AtomCutting_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomCutting >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomCutting_exposer.def( "__getstate_manages_dict__", true);
        AtomCutting_exposer.def( "__safe_for_unpickling__", true);
        AtomCutting_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomCutting > );
        AtomCutting_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomCutting > );
