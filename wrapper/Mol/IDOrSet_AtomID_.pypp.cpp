...
void register_IDOrSet_AtomID__class(){
    ...
    { //::SireID::IDOrSet< SireMol::AtomID >
        ...
        IDOrSet_AtomID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::IDOrSet<SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        IDOrSet_AtomID__exposer.def( "__getstate_manages_dict__", true);
        IDOrSet_AtomID__exposer.def( "__safe_for_unpickling__", true);
        IDOrSet_AtomID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::IDOrSet<SireMol::AtomID> > );
        IDOrSet_AtomID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::IDOrSet<SireMol::AtomID> > );
