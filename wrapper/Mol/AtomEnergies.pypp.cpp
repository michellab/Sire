...
void register_AtomEnergies_class(){
    ...
    { //::SireMol::AtomProperty< SireUnits::Dimension::PhysUnit< 1, 2, -2, 0, 0, -1, 0 > >
        ...
        AtomEnergies_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomProperty<SireUnits::Dimension::PhysUnit<1, 2, -2, 0, 0, -1, 0> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomEnergies_exposer.def( "__getstate_manages_dict__", true);
        AtomEnergies_exposer.def( "__safe_for_unpickling__", true);
        AtomEnergies_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomProperty<SireUnits::Dimension::PhysUnit<1, 2, -2, 0, 0, -1, 0> > > );
        AtomEnergies_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomProperty<SireUnits::Dimension::PhysUnit<1, 2, -2, 0, 0, -1, 0> > > );
