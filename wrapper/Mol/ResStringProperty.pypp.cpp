...
void register_ResStringProperty_class(){
    ...
    { //::SireMol::ResProperty< QString >
        ...
        ResStringProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ResProperty<QString> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResStringProperty_exposer.def( "__getstate_manages_dict__", true);
        ResStringProperty_exposer.def( "__safe_for_unpickling__", true);
        ResStringProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ResProperty<QString> > );
        ResStringProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ResProperty<QString> > );
