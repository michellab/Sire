...
void register_AtomVelocities_class(){
    ...
    { //::SireMol::AtomProperty< SireMaths::Vector3D< SireUnits::Dimension::Velocity > >
        ...
        AtomVelocities_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomProperty<SireMaths::Vector3D<SireUnits::Dimension::Velocity> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomVelocities_exposer.def( "__getstate_manages_dict__", true);
        AtomVelocities_exposer.def( "__safe_for_unpickling__", true);
        AtomVelocities_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomProperty<SireMaths::Vector3D<SireUnits::Dimension::Velocity> > > );
        AtomVelocities_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomProperty<SireMaths::Vector3D<SireUnits::Dimension::Velocity> > > );
