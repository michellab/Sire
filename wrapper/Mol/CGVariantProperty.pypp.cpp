...
void register_CGVariantProperty_class(){
    ...
    { //::SireMol::CGProperty< QVariant >
        ...
        CGVariantProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::CGProperty<QVariant> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CGVariantProperty_exposer.def( "__getstate_manages_dict__", true);
        CGVariantProperty_exposer.def( "__safe_for_unpickling__", true);
        CGVariantProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::CGProperty<QVariant> > );
        CGVariantProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::CGProperty<QVariant> > );
