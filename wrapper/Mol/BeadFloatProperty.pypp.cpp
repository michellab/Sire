...
void register_BeadFloatProperty_class(){
    ...
    { //::SireMol::BeadProperty< double >
        ...
        BeadFloatProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::BeadProperty<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        BeadFloatProperty_exposer.def( "__getstate_manages_dict__", true);
        BeadFloatProperty_exposer.def( "__safe_for_unpickling__", true);
        BeadFloatProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::BeadProperty<double> > );
        BeadFloatProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::BeadProperty<double> > );
