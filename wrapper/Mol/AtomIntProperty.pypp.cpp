...
void register_AtomIntProperty_class(){
    ...
    { //::SireMol::AtomProperty< long long >
        ...
        AtomIntProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomProperty<long long> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomIntProperty_exposer.def( "__getstate_manages_dict__", true);
        AtomIntProperty_exposer.def( "__safe_for_unpickling__", true);
        AtomIntProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomProperty<long long> > );
        AtomIntProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomProperty<long long> > );
