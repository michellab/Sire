...
void register_ResidueBeading_class(){
    ...
    { //::SireMol::ResidueBeading
        ...
        ResidueBeading_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ResidueBeading >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResidueBeading_exposer.def( "__getstate_manages_dict__", true);
        ResidueBeading_exposer.def( "__safe_for_unpickling__", true);
        ResidueBeading_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ResidueBeading > );
        ResidueBeading_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ResidueBeading > );
