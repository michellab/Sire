...
void register_AtomMCSMatcher_class(){
    ...
    { //::SireMol::AtomMCSMatcher
        ...
        AtomMCSMatcher_exposer.def( bp::init< SireUnits::Dimension::Time const &, bp::optional< bool > >(( bp::arg("timeout"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the timeout for the MCS match") );
        AtomMCSMatcher_exposer.def( bp::init< SireMol::AtomMatcher const &, bp::optional< bool > >(( bp::arg("prematcher"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the prematcher for the MCS match") );
        AtomMCSMatcher_exposer.def( bp::init< SireMol::AtomMatcher const &, SireUnits::Dimension::Time const &, bp::optional< bool > >(( bp::arg("prematcher"), bp::arg("timeout"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the timeout and prematcher for the MCS match") );
        AtomMCSMatcher_exposer.def( bp::init< bool, bp::optional< bool > >(( bp::arg("match_light_atoms"), bp::arg("verbose")=(bool)(false) ), "Constructor, specifying whether or not to match light atoms") );
        AtomMCSMatcher_exposer.def( bp::init< SireUnits::Dimension::Time const &, bool, bp::optional< bool > >(( bp::arg("timeout"), bp::arg("match_light_atoms"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the timeout for the MCS match, and specifying whether or not\nto match light atoms") );
        AtomMCSMatcher_exposer.def( bp::init< SireMol::AtomMatcher const &, bool, bp::optional< bool > >(( bp::arg("prematcher"), bp::arg("match_light_atoms"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the prematcher for the MCS match,\nand specifying whether or not to match light atoms\n") );
        AtomMCSMatcher_exposer.def( bp::init< SireMol::AtomMatcher const &, SireUnits::Dimension::Time const &, bool, bp::optional< bool > >(( bp::arg("prematcher"), bp::arg("timeout"), bp::arg("match_light_atoms"), bp::arg("verbose")=(bool)(false) ), "Construct specifying the timeout and prematcher for the MCS match,\nand specifying whether or not to match light atoms\n") );
