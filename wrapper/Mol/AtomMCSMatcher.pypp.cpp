...
void register_AtomMCSMatcher_class(){
    ...
    { //::SireMol::AtomMCSMatcher
        ...
        AtomMCSMatcher_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomMCSMatcher >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomMCSMatcher_exposer.def( "__getstate_manages_dict__", true);
        AtomMCSMatcher_exposer.def( "__safe_for_unpickling__", true);
        AtomMCSMatcher_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomMCSMatcher > );
        AtomMCSMatcher_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomMCSMatcher > );
