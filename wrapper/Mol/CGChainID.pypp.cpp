...
void register_CGChainID_class(){
    ...
    { //::SireMol::GroupGroupID< SireMol::CGID, SireMol::ChainID >
        ...
        CGChainID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CGChainID_exposer.def( "__getstate_manages_dict__", true);
        CGChainID_exposer.def( "__safe_for_unpickling__", true);
        CGChainID_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID> > );
        CGChainID_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID> > );
