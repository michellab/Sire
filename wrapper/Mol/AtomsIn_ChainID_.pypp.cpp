...
void register_AtomsIn_ChainID__class(){
    ...
    { //::SireMol::AtomsIn< SireMol::ChainID >
        ...
        AtomsIn_ChainID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomsIn<SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomsIn_ChainID__exposer.def( "__getstate_manages_dict__", true);
        AtomsIn_ChainID__exposer.def( "__safe_for_unpickling__", true);
        AtomsIn_ChainID__exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomsIn<SireMol::ChainID> > );
        AtomsIn_ChainID__exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomsIn<SireMol::ChainID> > );
