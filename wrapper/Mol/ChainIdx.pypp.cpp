...
void register_ChainIdx_class(){
    ...
    { //::SireMol::ChainIdx
        ...
        ChainIdx_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ChainIdx >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ChainIdx_exposer.def( "__getstate_manages_dict__", true);
        ChainIdx_exposer.def( "__safe_for_unpickling__", true);
        ChainIdx_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ChainIdx > );
        ChainIdx_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ChainIdx > );
