...
void register_ChainAtomID_class(){
    ...
    { //::SireMol::GroupAtomID< SireMol::ChainID, SireMol::AtomID >
        ...
        ChainAtomID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupAtomID<SireMol::ChainID, SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ChainAtomID_exposer.def( "__getstate_manages_dict__", true);
        ChainAtomID_exposer.def( "__safe_for_unpickling__", true);
        ChainAtomID_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::GroupAtomID<SireMol::ChainID, SireMol::AtomID> > );
        ChainAtomID_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::GroupAtomID<SireMol::ChainID, SireMol::AtomID> > );
