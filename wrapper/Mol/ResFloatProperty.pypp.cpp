...
void register_ResFloatProperty_class(){
    ...
    { //::SireMol::ResProperty< double >
        ...
        ResFloatProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ResProperty<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResFloatProperty_exposer.def( "__getstate_manages_dict__", true);
        ResFloatProperty_exposer.def( "__safe_for_unpickling__", true);
        ResFloatProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ResProperty<double> > );
        ResFloatProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ResProperty<double> > );
