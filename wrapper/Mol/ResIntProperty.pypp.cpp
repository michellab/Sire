...
void register_ResIntProperty_class(){
    ...
    { //::SireMol::ResProperty< long long >
        ...
        ResIntProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ResProperty<long long> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ResIntProperty_exposer.def( "__getstate_manages_dict__", true);
        ResIntProperty_exposer.def( "__safe_for_unpickling__", true);
        ResIntProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ResProperty<long long> > );
        ResIntProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ResProperty<long long> > );
