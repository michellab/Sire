...
void register_AtomFloatProperty_class(){
    ...
    { //::SireMol::AtomProperty< double >
        ...
        AtomFloatProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomProperty<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomFloatProperty_exposer.def( "__getstate_manages_dict__", true);
        AtomFloatProperty_exposer.def( "__safe_for_unpickling__", true);
        AtomFloatProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomProperty<double> > );
        AtomFloatProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomProperty<double> > );
