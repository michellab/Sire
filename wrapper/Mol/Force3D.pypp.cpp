...
void register_Force3D_class(){
    ...
    { //::SireMaths::Vector3D< SireUnits::Dimension::PhysUnit< 1, 1, -2, 0, 0, 0, 0 > >
        ...
        Force3D_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Vector3D<SireUnits::Dimension::PhysUnit<1, 1, -2, 0, 0, 0, 0> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Force3D_exposer.def( "__getstate_manages_dict__", true);
        Force3D_exposer.def( "__safe_for_unpickling__", true);
        Force3D_exposer.def( "__setstate__", &__setstate__base64< ::SireMaths::Vector3D<SireUnits::Dimension::PhysUnit<1, 1, -2, 0, 0, 0, 0> > > );
        Force3D_exposer.def( "__getstate__", &__getstate__base64< ::SireMaths::Vector3D<SireUnits::Dimension::PhysUnit<1, 1, -2, 0, 0, 0, 0> > > );
