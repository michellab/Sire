...
void register_MatchAll_AtomID__class(){
    ...
    { //::SireID::MatchAll< SireMol::AtomID >
        ...
        MatchAll_AtomID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::MatchAll<SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MatchAll_AtomID__exposer.def( "__getstate_manages_dict__", true);
        MatchAll_AtomID__exposer.def( "__safe_for_unpickling__", true);
        MatchAll_AtomID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::MatchAll<SireMol::AtomID> > );
        MatchAll_AtomID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::MatchAll<SireMol::AtomID> > );
