...
void register_ChainResID_class(){
    ...
    { //::SireMol::ChainResID
        ...
        ChainResID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ChainResID >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ChainResID_exposer.def( "__getstate_manages_dict__", true);
        ChainResID_exposer.def( "__safe_for_unpickling__", true);
        ChainResID_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ChainResID > );
        ChainResID_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ChainResID > );
