...
void register_ConnectivityBase_class(){
    ...
    { //::SireMol::ConnectivityBase
        ...
        ConnectivityBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::ConnectivityBase >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ConnectivityBase_exposer.def( "__getstate_manages_dict__", true);
        ConnectivityBase_exposer.def( "__safe_for_unpickling__", true);
        ConnectivityBase_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::ConnectivityBase > );
        ConnectivityBase_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::ConnectivityBase > );
