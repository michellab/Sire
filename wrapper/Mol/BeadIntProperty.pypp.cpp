...
void register_BeadIntProperty_class(){
    ...
    { //::SireMol::BeadProperty< long long >
        ...
        BeadIntProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::BeadProperty<long long> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        BeadIntProperty_exposer.def( "__getstate_manages_dict__", true);
        BeadIntProperty_exposer.def( "__safe_for_unpickling__", true);
        BeadIntProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::BeadProperty<long long> > );
        BeadIntProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::BeadProperty<long long> > );
