...
void register_SegFloatProperty_class(){
    ...
    { //::SireMol::SegProperty< double >
        ...
        SegFloatProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::SegProperty<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SegFloatProperty_exposer.def( "__getstate_manages_dict__", true);
        SegFloatProperty_exposer.def( "__safe_for_unpickling__", true);
        SegFloatProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::SegProperty<double> > );
        SegFloatProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::SegProperty<double> > );
