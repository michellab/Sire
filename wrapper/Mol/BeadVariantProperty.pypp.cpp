...
void register_BeadVariantProperty_class(){
    ...
    { //::SireMol::BeadProperty< QVariant >
        ...
        BeadVariantProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::BeadProperty<QVariant> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        BeadVariantProperty_exposer.def( "__getstate_manages_dict__", true);
        BeadVariantProperty_exposer.def( "__safe_for_unpickling__", true);
        BeadVariantProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::BeadProperty<QVariant> > );
        BeadVariantProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::BeadProperty<QVariant> > );
