...
void register_AtomBeads_class(){
    ...
    { //::SireMol::AtomProperty< SireMol::BeadNum >
        ...
        AtomBeads_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomProperty<SireMol::BeadNum> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomBeads_exposer.def( "__getstate_manages_dict__", true);
        AtomBeads_exposer.def( "__safe_for_unpickling__", true);
        AtomBeads_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomProperty<SireMol::BeadNum> > );
        AtomBeads_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomProperty<SireMol::BeadNum> > );
