...
void register_AtomIdxMatcher_class(){
    ...
    { //::SireMol::AtomIdxMatcher
        ...
        AtomIdxMatcher_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomIdxMatcher >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomIdxMatcher_exposer.def( "__getstate_manages_dict__", true);
        AtomIdxMatcher_exposer.def( "__safe_for_unpickling__", true);
        AtomIdxMatcher_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::AtomIdxMatcher > );
        AtomIdxMatcher_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::AtomIdxMatcher > );
