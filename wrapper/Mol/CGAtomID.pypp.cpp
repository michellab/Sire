...
void register_CGAtomID_class(){
    ...
    { //::SireMol::GroupAtomID< SireMol::CGID, SireMol::AtomID >
        ...
        CGAtomID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupAtomID<SireMol::CGID, SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CGAtomID_exposer.def( "__getstate_manages_dict__", true);
        CGAtomID_exposer.def( "__safe_for_unpickling__", true);
        CGAtomID_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::GroupAtomID<SireMol::CGID, SireMol::AtomID> > );
        CGAtomID_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::GroupAtomID<SireMol::CGID, SireMol::AtomID> > );
