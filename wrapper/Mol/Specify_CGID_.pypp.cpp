...
void register_Specify_CGID__class(){
    ...
    { //::SireID::Specify< SireMol::CGID >
        ...
        Specify_CGID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::Specify<SireMol::CGID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Specify_CGID__exposer.def( "__getstate_manages_dict__", true);
        Specify_CGID__exposer.def( "__safe_for_unpickling__", true);
        Specify_CGID__exposer.def( "__setstate__", &__setstate__base64< ::SireID::Specify<SireMol::CGID> > );
        Specify_CGID__exposer.def( "__getstate__", &__getstate__base64< ::SireID::Specify<SireMol::CGID> > );
