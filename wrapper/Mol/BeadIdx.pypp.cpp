...
void register_BeadIdx_class(){
    ...
    { //::SireMol::BeadIdx
        ...
        BeadIdx_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::BeadIdx >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        BeadIdx_exposer.def( "__getstate_manages_dict__", true);
        BeadIdx_exposer.def( "__safe_for_unpickling__", true);
        BeadIdx_exposer.def( "__setstate__", &__setstate__base64< ::SireMol::BeadIdx > );
        BeadIdx_exposer.def( "__getstate__", &__getstate__base64< ::SireMol::BeadIdx > );
