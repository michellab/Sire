...
void register_Property_class(){
    ...
    { //::SireBase::Property
        ...
        Property_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::Property >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Property_exposer.def( "__getstate_manages_dict__", true);
        Property_exposer.def( "__safe_for_unpickling__", true);
        Property_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::Property > );
        Property_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::Property > );
