...
void register_BooleanProperty_class(){
    ...
    { //::SireBase::BooleanProperty
        ...
        BooleanProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::BooleanProperty >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        BooleanProperty_exposer.def( "__getstate_manages_dict__", true);
        BooleanProperty_exposer.def( "__safe_for_unpickling__", true);
        BooleanProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::BooleanProperty > );
        BooleanProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::BooleanProperty > );
