...
void register_ChunkedVector_double__class(){
    ...
    { //::SireBase::ChunkedVector< double, 100 >
        ...
        ChunkedVector_double__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::ChunkedVector<double, 100> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ChunkedVector_double__exposer.def( "__getstate_manages_dict__", true);
        ChunkedVector_double__exposer.def( "__safe_for_unpickling__", true);
        ChunkedVector_double__exposer.def( "__setstate__", &__setstate__base64< ::SireBase::ChunkedVector<double, 100> > );
        ChunkedVector_double__exposer.def( "__getstate__", &__getstate__base64< ::SireBase::ChunkedVector<double, 100> > );
