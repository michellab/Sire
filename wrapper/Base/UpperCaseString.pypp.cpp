...
void register_UpperCaseString_class(){
    ...
    { //::SireBase::UpperCaseString
        ...
        UpperCaseString_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::UpperCaseString >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        UpperCaseString_exposer.def( "__getstate_manages_dict__", true);
        UpperCaseString_exposer.def( "__safe_for_unpickling__", true);
        UpperCaseString_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::UpperCaseString > );
        UpperCaseString_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::UpperCaseString > );
