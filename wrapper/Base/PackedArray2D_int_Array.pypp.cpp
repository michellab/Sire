...
void register_PackedArray2D_int_Array_class(){
    ...
    { //::SireBase::detail::PackedArray2D_Array< int >
        ...
        PackedArray2D_int_Array_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::detail::PackedArray2D_Array<int> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PackedArray2D_int_Array_exposer.def( "__getstate_manages_dict__", true);
        PackedArray2D_int_Array_exposer.def( "__safe_for_unpickling__", true);
        PackedArray2D_int_Array_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::detail::PackedArray2D_Array<int> > );
        PackedArray2D_int_Array_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::detail::PackedArray2D_Array<int> > );
