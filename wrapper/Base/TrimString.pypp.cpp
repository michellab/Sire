...
void register_TrimString_class(){
    ...
    { //::SireBase::TrimString
        ...
        TrimString_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::TrimString >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TrimString_exposer.def( "__getstate_manages_dict__", true);
        TrimString_exposer.def( "__safe_for_unpickling__", true);
        TrimString_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::TrimString > );
        TrimString_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::TrimString > );
