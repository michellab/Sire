...
void register_Properties_class(){
    ...
    { //::SireBase::Properties
        ...
        Properties_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::Properties >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Properties_exposer.def( "__getstate_manages_dict__", true);
        Properties_exposer.def( "__safe_for_unpickling__", true);
        Properties_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::Properties > );
        Properties_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::Properties > );
