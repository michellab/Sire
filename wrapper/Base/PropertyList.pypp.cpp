...
void register_PropertyList_class(){
    ...
    { //::SireBase::PropertyList
        ...
        PropertyList_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::PropertyList >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PropertyList_exposer.def( "__getstate_manages_dict__", true);
        PropertyList_exposer.def( "__safe_for_unpickling__", true);
        PropertyList_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::PropertyList > );
        PropertyList_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::PropertyList > );
