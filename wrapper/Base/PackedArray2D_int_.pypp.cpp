...
void register_PackedArray2D_int__class(){
    ...
    { //::SireBase::PackedArray2D< int >
        ...
        PackedArray2D_int__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::PackedArray2D<int> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PackedArray2D_int__exposer.def( "__getstate_manages_dict__", true);
        PackedArray2D_int__exposer.def( "__safe_for_unpickling__", true);
        PackedArray2D_int__exposer.def( "__setstate__", &__setstate__base64< ::SireBase::PackedArray2D<int> > );
        PackedArray2D_int__exposer.def( "__getstate__", &__getstate__base64< ::SireBase::PackedArray2D<int> > );
