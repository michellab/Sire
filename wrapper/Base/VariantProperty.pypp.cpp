...
void register_VariantProperty_class(){
    ...
    { //::SireBase::VariantProperty
        ...
        VariantProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::VariantProperty >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        VariantProperty_exposer.def( "__getstate_manages_dict__", true);
        VariantProperty_exposer.def( "__safe_for_unpickling__", true);
        VariantProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireBase::VariantProperty > );
        VariantProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireBase::VariantProperty > );
