...
void register_ExpressionProperty_class(){
    ...
    { //::SireCAS::ExpressionProperty
        ...
        ExpressionProperty_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::ExpressionProperty >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ExpressionProperty_exposer.def( "__getstate_manages_dict__", true);
        ExpressionProperty_exposer.def( "__safe_for_unpickling__", true);
        ExpressionProperty_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::ExpressionProperty > );
        ExpressionProperty_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::ExpressionProperty > );
