...
void register_Max_class(){
    ...
    { //::SireCAS::Max
        ...
        Max_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::Max >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Max_exposer.def( "__getstate_manages_dict__", true);
        Max_exposer.def( "__safe_for_unpickling__", true);
        Max_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::Max > );
        Max_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::Max > );
