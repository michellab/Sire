...
void register_GreaterOrEqualThan_class(){
    ...
    { //::SireCAS::GreaterOrEqualThan
        ...
        GreaterOrEqualThan_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::GreaterOrEqualThan >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GreaterOrEqualThan_exposer.def( "__getstate_manages_dict__", true);
        GreaterOrEqualThan_exposer.def( "__safe_for_unpickling__", true);
        GreaterOrEqualThan_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::GreaterOrEqualThan > );
        GreaterOrEqualThan_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::GreaterOrEqualThan > );
