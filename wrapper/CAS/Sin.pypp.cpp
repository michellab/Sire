...
void register_Sin_class(){
    ...
    { //::SireCAS::Sin
        ...
        Sin_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::Sin >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Sin_exposer.def( "__getstate_manages_dict__", true);
        Sin_exposer.def( "__safe_for_unpickling__", true);
        Sin_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::Sin > );
        Sin_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::Sin > );
