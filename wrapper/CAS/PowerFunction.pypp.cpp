...
void register_PowerFunction_class(){
    ...
    { //::SireCAS::PowerFunction
        ...
        PowerFunction_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::PowerFunction >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PowerFunction_exposer.def( "__getstate_manages_dict__", true);
        PowerFunction_exposer.def( "__safe_for_unpickling__", true);
        PowerFunction_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::PowerFunction > );
        PowerFunction_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::PowerFunction > );
