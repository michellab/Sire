...
void register_Condition_class(){
    ...
    { //::SireCAS::Condition
        ...
        Condition_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::Condition >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Condition_exposer.def( "__getstate_manages_dict__", true);
        Condition_exposer.def( "__safe_for_unpickling__", true);
        Condition_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::Condition > );
        Condition_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::Condition > );
