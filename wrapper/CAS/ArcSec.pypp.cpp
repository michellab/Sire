...
void register_ArcSec_class(){
    ...
    { //::SireCAS::ArcSec
        ...
        ArcSec_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::ArcSec >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ArcSec_exposer.def( "__getstate_manages_dict__", true);
        ArcSec_exposer.def( "__safe_for_unpickling__", true);
        ArcSec_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::ArcSec > );
        ArcSec_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::ArcSec > );
