...
void register_EqualTo_class(){
    ...
    { //::SireCAS::EqualTo
        ...
        EqualTo_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::EqualTo >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        EqualTo_exposer.def( "__getstate_manages_dict__", true);
        EqualTo_exposer.def( "__safe_for_unpickling__", true);
        EqualTo_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::EqualTo > );
        EqualTo_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::EqualTo > );
