...
void register_ComplexValues_class(){
    ...
    { //::SireCAS::ComplexValues
        ...
        ComplexValues_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::ComplexValues >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ComplexValues_exposer.def( "__getstate_manages_dict__", true);
        ComplexValues_exposer.def( "__safe_for_unpickling__", true);
        ComplexValues_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::ComplexValues > );
        ComplexValues_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::ComplexValues > );
