...
void register_Cos_class(){
    ...
    { //::SireCAS::Cos
        ...
        Cos_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::Cos >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Cos_exposer.def( "__getstate_manages_dict__", true);
        Cos_exposer.def( "__safe_for_unpickling__", true);
        Cos_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::Cos > );
        Cos_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::Cos > );
