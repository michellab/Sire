...
void register_ExpressionBase_class(){
    ...
    { //::SireCAS::ExpressionBase
        ...
        ExpressionBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCAS::ExpressionBase >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ExpressionBase_exposer.def( "__getstate_manages_dict__", true);
        ExpressionBase_exposer.def( "__safe_for_unpickling__", true);
        ExpressionBase_exposer.def( "__setstate__", &__setstate__base64< ::SireCAS::ExpressionBase > );
        ExpressionBase_exposer.def( "__getstate__", &__getstate__base64< ::SireCAS::ExpressionBase > );
