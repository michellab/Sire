...
void register_PeriodicBox_class(){
    ...
    { //::SireVol::PeriodicBox
        ...
        PeriodicBox_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireVol::PeriodicBox >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PeriodicBox_exposer.def( "__getstate_manages_dict__", true);
        PeriodicBox_exposer.def( "__safe_for_unpickling__", true);
        PeriodicBox_exposer.def( "__setstate__", &__setstate__base64< ::SireVol::PeriodicBox > );
        PeriodicBox_exposer.def( "__getstate__", &__getstate__base64< ::SireVol::PeriodicBox > );
