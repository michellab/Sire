...
void register_Grid_class(){
    ...
    { //::SireVol::Grid
        ...
        Grid_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireVol::Grid >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Grid_exposer.def( "__getstate_manages_dict__", true);
        Grid_exposer.def( "__safe_for_unpickling__", true);
        Grid_exposer.def( "__setstate__", &__setstate__base64< ::SireVol::Grid > );
        Grid_exposer.def( "__getstate__", &__getstate__base64< ::SireVol::Grid > );
