...
void register_RegularGrid_class(){
    ...
    { //::SireVol::RegularGrid
        ...
        RegularGrid_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireVol::RegularGrid >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        RegularGrid_exposer.def( "__getstate_manages_dict__", true);
        RegularGrid_exposer.def( "__safe_for_unpickling__", true);
        RegularGrid_exposer.def( "__setstate__", &__setstate__base64< ::SireVol::RegularGrid > );
        RegularGrid_exposer.def( "__getstate__", &__getstate__base64< ::SireVol::RegularGrid > );
