...
void register_AABox_class(){
    ...
    { //::SireVol::AABox
        ...
        AABox_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireVol::AABox >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AABox_exposer.def( "__getstate_manages_dict__", true);
        AABox_exposer.def( "__safe_for_unpickling__", true);
        AABox_exposer.def( "__setstate__", &__setstate__base64< ::SireVol::AABox > );
        AABox_exposer.def( "__getstate__", &__getstate__base64< ::SireVol::AABox > );
