...
void register_QMMMFF_class(){
    ...
    { //::Squire::QMMMFF
        ...
        QMMMFF_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::QMMMFF >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        QMMMFF_exposer.def( "__getstate_manages_dict__", true);
        QMMMFF_exposer.def( "__safe_for_unpickling__", true);
        QMMMFF_exposer.def( "__setstate__", &__setstate__base64< ::Squire::QMMMFF > );
        QMMMFF_exposer.def( "__getstate__", &__getstate__base64< ::Squire::QMMMFF > );
