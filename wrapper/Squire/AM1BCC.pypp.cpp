...
void register_AM1BCC_class(){
    ...
    { //::Squire::AM1BCC
        ...
        AM1BCC_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::AM1BCC >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AM1BCC_exposer.def( "__getstate_manages_dict__", true);
        AM1BCC_exposer.def( "__safe_for_unpickling__", true);
        AM1BCC_exposer.def( "__setstate__", &__setstate__base64< ::Squire::AM1BCC > );
        AM1BCC_exposer.def( "__getstate__", &__getstate__base64< ::Squire::AM1BCC > );
