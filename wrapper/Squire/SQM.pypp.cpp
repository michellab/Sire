...
void register_SQM_class(){
    ...
    { //::Squire::SQM
        ...
        SQM_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::SQM >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SQM_exposer.def( "__getstate_manages_dict__", true);
        SQM_exposer.def( "__safe_for_unpickling__", true);
        SQM_exposer.def( "__setstate__", &__setstate__base64< ::Squire::SQM > );
        SQM_exposer.def( "__getstate__", &__getstate__base64< ::Squire::SQM > );
