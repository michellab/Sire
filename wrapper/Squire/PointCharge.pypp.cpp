...
void register_PointCharge_class(){
    ...
    { //::Squire::PointCharge
        ...
        PointCharge_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::PointCharge >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PointCharge_exposer.def( "__getstate_manages_dict__", true);
        PointCharge_exposer.def( "__safe_for_unpickling__", true);
        PointCharge_exposer.def( "__setstate__", &__setstate__base64< ::Squire::PointCharge > );
        PointCharge_exposer.def( "__getstate__", &__getstate__base64< ::Squire::PointCharge > );
