...
void register_PS_GTO_class(){
    ...
    { //::Squire::PS_GTO
        ...
        PS_GTO_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::PS_GTO >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PS_GTO_exposer.def( "__getstate_manages_dict__", true);
        PS_GTO_exposer.def( "__safe_for_unpickling__", true);
        PS_GTO_exposer.def( "__setstate__", &__setstate__base64< ::Squire::PS_GTO > );
        PS_GTO_exposer.def( "__getstate__", &__getstate__base64< ::Squire::PS_GTO > );
