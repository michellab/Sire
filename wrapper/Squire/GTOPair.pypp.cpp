...
void register_GTOPair_class(){
    ...
    { //::Squire::GTOPair
        ...
        GTOPair_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::GTOPair >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GTOPair_exposer.def( "__getstate_manages_dict__", true);
        GTOPair_exposer.def( "__safe_for_unpickling__", true);
        GTOPair_exposer.def( "__setstate__", &__setstate__base64< ::Squire::GTOPair > );
        GTOPair_exposer.def( "__getstate__", &__getstate__base64< ::Squire::GTOPair > );
