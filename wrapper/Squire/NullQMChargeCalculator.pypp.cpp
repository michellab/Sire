...
void register_NullQMChargeCalculator_class(){
    ...
    { //::Squire::NullQMChargeCalculator
        ...
        NullQMChargeCalculator_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::NullQMChargeCalculator >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullQMChargeCalculator_exposer.def( "__getstate_manages_dict__", true);
        NullQMChargeCalculator_exposer.def( "__safe_for_unpickling__", true);
        NullQMChargeCalculator_exposer.def( "__setstate__", &__setstate__base64< ::Squire::NullQMChargeCalculator > );
        NullQMChargeCalculator_exposer.def( "__getstate__", &__getstate__base64< ::Squire::NullQMChargeCalculator > );
