...
void register_NullQM_class(){
    ...
    { //::Squire::NullQM
        ...
        NullQM_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::NullQM >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullQM_exposer.def( "__getstate_manages_dict__", true);
        NullQM_exposer.def( "__safe_for_unpickling__", true);
        NullQM_exposer.def( "__setstate__", &__setstate__base64< ::Squire::NullQM > );
        NullQM_exposer.def( "__getstate__", &__getstate__base64< ::Squire::NullQM > );
