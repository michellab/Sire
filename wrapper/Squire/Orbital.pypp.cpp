...
void register_Orbital_class(){
    ...
    { //::Squire::Orbital
        ...
        Orbital_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::Orbital >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Orbital_exposer.def( "__getstate_manages_dict__", true);
        Orbital_exposer.def( "__safe_for_unpickling__", true);
        Orbital_exposer.def( "__setstate__", &__setstate__base64< ::Squire::Orbital > );
        Orbital_exposer.def( "__getstate__", &__getstate__base64< ::Squire::Orbital > );
