...
void register_QMComponent_class(){
    ...
    { //::Squire::QMComponent
        ...
        QMComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::Squire::QMComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        QMComponent_exposer.def( "__getstate_manages_dict__", true);
        QMComponent_exposer.def( "__safe_for_unpickling__", true);
        QMComponent_exposer.def( "__setstate__", &__setstate__base64< ::Squire::QMComponent > );
        QMComponent_exposer.def( "__getstate__", &__getstate__base64< ::Squire::QMComponent > );
