...
void register_GromacsDihedral_class(){
    ...
    { //::SireMM::GromacsDihedral
        ...
        GromacsDihedral_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::GromacsDihedral >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GromacsDihedral_exposer.def( "__getstate_manages_dict__", true);
        GromacsDihedral_exposer.def( "__safe_for_unpickling__", true);
        GromacsDihedral_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::GromacsDihedral > );
        GromacsDihedral_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::GromacsDihedral > );
