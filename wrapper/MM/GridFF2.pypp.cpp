...
void register_GridFF2_class(){
    ...
    { //::SireMM::GridFF2
        ...
        GridFF2_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::GridFF2 >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GridFF2_exposer.def( "__getstate_manages_dict__", true);
        GridFF2_exposer.def( "__safe_for_unpickling__", true);
        GridFF2_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::GridFF2 > );
        GridFF2_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::GridFF2 > );
