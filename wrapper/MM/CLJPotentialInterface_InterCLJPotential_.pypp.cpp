...
void register_CLJPotentialInterface_InterCLJPotential__class(){
    ...
    { //::SireMM::CLJPotentialInterface< SireMM::InterCLJPotential >
        ...
        CLJPotentialInterface_InterCLJPotential__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CLJPotentialInterface_InterCLJPotential__exposer.def( "__getstate_manages_dict__", true);
        CLJPotentialInterface_InterCLJPotential__exposer.def( "__safe_for_unpickling__", true);
        CLJPotentialInterface_InterCLJPotential__exposer.def( "__setstate__", &__setstate__base64< ::SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> > );
        CLJPotentialInterface_InterCLJPotential__exposer.def( "__getstate__", &__getstate__base64< ::SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> > );
