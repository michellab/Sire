...
void register_AtomFunction_class(){
    ...
    { //::SireMM::AtomFunction
        ...
        AtomFunction_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::AtomFunction >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomFunction_exposer.def( "__getstate_manages_dict__", true);
        AtomFunction_exposer.def( "__safe_for_unpickling__", true);
        AtomFunction_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::AtomFunction > );
        AtomFunction_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::AtomFunction > );
