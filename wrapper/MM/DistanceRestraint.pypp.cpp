...
void register_DistanceRestraint_class(){
    ...
    { //::SireMM::DistanceRestraint
        ...
        DistanceRestraint_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::DistanceRestraint >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        DistanceRestraint_exposer.def( "__getstate_manages_dict__", true);
        DistanceRestraint_exposer.def( "__safe_for_unpickling__", true);
        DistanceRestraint_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::DistanceRestraint > );
        DistanceRestraint_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::DistanceRestraint > );
