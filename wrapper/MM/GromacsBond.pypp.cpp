...
void register_GromacsBond_class(){
    ...
    { //::SireMM::GromacsBond
        ...
        GromacsBond_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::GromacsBond >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GromacsBond_exposer.def( "__getstate_manages_dict__", true);
        GromacsBond_exposer.def( "__safe_for_unpickling__", true);
        GromacsBond_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::GromacsBond > );
        GromacsBond_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::GromacsBond > );
