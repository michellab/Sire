...
void register_Restraint3D_class(){
    ...
    { //::SireMM::Restraint3D
        ...
        Restraint3D_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::Restraint3D >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Restraint3D_exposer.def( "__getstate_manages_dict__", true);
        Restraint3D_exposer.def( "__safe_for_unpickling__", true);
        Restraint3D_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::Restraint3D > );
        Restraint3D_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::Restraint3D > );
