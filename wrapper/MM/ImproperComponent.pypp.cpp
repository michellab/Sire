...
void register_ImproperComponent_class(){
    ...
    { //::SireMM::ImproperComponent
        ...
        ImproperComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::ImproperComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ImproperComponent_exposer.def( "__getstate_manages_dict__", true);
        ImproperComponent_exposer.def( "__safe_for_unpickling__", true);
        ImproperComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::ImproperComponent > );
        ImproperComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::ImproperComponent > );
