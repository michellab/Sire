...
void register_InternalParameters3D_class(){
    ...
    { //::SireMM::InternalParameters3D
        ...
        InternalParameters3D_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::InternalParameters3D >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InternalParameters3D_exposer.def( "__getstate_manages_dict__", true);
        InternalParameters3D_exposer.def( "__safe_for_unpickling__", true);
        InternalParameters3D_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::InternalParameters3D > );
        InternalParameters3D_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::InternalParameters3D > );
