...
void register_DoubleDistanceRestraint_class(){
    ...
    { //::SireMM::DoubleDistanceRestraint
        ...
        DoubleDistanceRestraint_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::DoubleDistanceRestraint >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        DoubleDistanceRestraint_exposer.def( "__getstate_manages_dict__", true);
        DoubleDistanceRestraint_exposer.def( "__safe_for_unpickling__", true);
        DoubleDistanceRestraint_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::DoubleDistanceRestraint > );
        DoubleDistanceRestraint_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::DoubleDistanceRestraint > );
