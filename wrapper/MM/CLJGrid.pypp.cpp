...
void register_CLJGrid_class(){
    ...
    { //::SireMM::CLJGrid
        ...
        CLJGrid_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::CLJGrid >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CLJGrid_exposer.def( "__getstate_manages_dict__", true);
        CLJGrid_exposer.def( "__safe_for_unpickling__", true);
        CLJGrid_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::CLJGrid > );
        CLJGrid_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::CLJGrid > );
