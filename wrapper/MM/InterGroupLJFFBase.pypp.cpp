...
void register_InterGroupLJFFBase_class(){
    ...
    { //::SireFF::Inter2B2GFF< SireMM::LJPotentialInterface< SireMM::InterLJPotential > >
        ...
        InterGroupLJFFBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::Inter2B2GFF<SireMM::LJPotentialInterface<SireMM::InterLJPotential> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InterGroupLJFFBase_exposer.def( "__getstate_manages_dict__", true);
        InterGroupLJFFBase_exposer.def( "__safe_for_unpickling__", true);
        InterGroupLJFFBase_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::Inter2B2GFF<SireMM::LJPotentialInterface<SireMM::InterLJPotential> > > );
        InterGroupLJFFBase_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::Inter2B2GFF<SireMM::LJPotentialInterface<SireMM::InterLJPotential> > > );
