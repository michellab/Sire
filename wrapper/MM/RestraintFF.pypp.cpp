...
void register_RestraintFF_class(){
    ...
    { //::SireMM::RestraintFF
        ...
        RestraintFF_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::RestraintFF >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        RestraintFF_exposer.def( "__getstate_manages_dict__", true);
        RestraintFF_exposer.def( "__safe_for_unpickling__", true);
        RestraintFF_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::RestraintFF > );
        RestraintFF_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::RestraintFF > );
