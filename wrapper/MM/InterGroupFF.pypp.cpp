...
void register_InterGroupFF_class(){
    ...
    { //::SireMM::InterGroupFF
        ...
        InterGroupFF_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::InterGroupFF >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InterGroupFF_exposer.def( "__getstate_manages_dict__", true);
        InterGroupFF_exposer.def( "__safe_for_unpickling__", true);
        InterGroupFF_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::InterGroupFF > );
        InterGroupFF_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::InterGroupFF > );
