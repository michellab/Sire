...
void register_MultiCLJComponent_class(){
    ...
    { //::SireMM::MultiCLJComponent
        ...
        MultiCLJComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::MultiCLJComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MultiCLJComponent_exposer.def( "__getstate_manages_dict__", true);
        MultiCLJComponent_exposer.def( "__safe_for_unpickling__", true);
        MultiCLJComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::MultiCLJComponent > );
        MultiCLJComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::MultiCLJComponent > );
