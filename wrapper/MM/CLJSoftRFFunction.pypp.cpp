...
void register_CLJSoftRFFunction_class(){
    ...
    { //::SireMM::CLJSoftRFFunction
        ...
        CLJSoftRFFunction_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::CLJSoftRFFunction >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CLJSoftRFFunction_exposer.def( "__getstate_manages_dict__", true);
        CLJSoftRFFunction_exposer.def( "__safe_for_unpickling__", true);
        CLJSoftRFFunction_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::CLJSoftRFFunction > );
        CLJSoftRFFunction_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::CLJSoftRFFunction > );
