...
void register_GroupInternalParameters_class(){
    ...
    { //::SireMM::GroupInternalParameters
        ...
        GroupInternalParameters_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::GroupInternalParameters >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GroupInternalParameters_exposer.def( "__getstate_manages_dict__", true);
        GroupInternalParameters_exposer.def( "__safe_for_unpickling__", true);
        GroupInternalParameters_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::GroupInternalParameters > );
        GroupInternalParameters_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::GroupInternalParameters > );
