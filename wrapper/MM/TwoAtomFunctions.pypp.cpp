...
void register_TwoAtomFunctions_class(){
    ...
    { //::SireMM::TwoAtomFunctions
        ...
        TwoAtomFunctions_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::TwoAtomFunctions >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TwoAtomFunctions_exposer.def( "__getstate_manages_dict__", true);
        TwoAtomFunctions_exposer.def( "__safe_for_unpickling__", true);
        TwoAtomFunctions_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::TwoAtomFunctions > );
        TwoAtomFunctions_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::TwoAtomFunctions > );
