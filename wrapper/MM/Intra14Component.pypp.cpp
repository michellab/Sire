...
void register_Intra14Component_class(){
    ...
    { //::SireMM::Intra14Component
        ...
        Intra14Component_exposer_t Intra14Component_exposer = Intra14Component_exposer_t( "Intra14Component", "", bp::init< bp::optional< SireFF::FFName const & > >(( bp::arg("name")=SireFF::FFName() ), "Constructor") );
