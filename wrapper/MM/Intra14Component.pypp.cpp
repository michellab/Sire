...
void register_Intra14Component_class(){
    ...
    { //::SireMM::Intra14Component
        ...
        Intra14Component_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::Intra14Component >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Intra14Component_exposer.def( "__getstate_manages_dict__", true);
        Intra14Component_exposer.def( "__safe_for_unpickling__", true);
        Intra14Component_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::Intra14Component > );
        Intra14Component_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::Intra14Component > );
