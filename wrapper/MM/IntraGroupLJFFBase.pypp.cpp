...
void register_IntraGroupLJFFBase_class(){
    ...
    { //::SireFF::Intra2B2GFF< SireMM::LJPotentialInterface< SireMM::IntraLJPotential > >
        ...
        IntraGroupLJFFBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::Intra2B2GFF<SireMM::LJPotentialInterface<SireMM::IntraLJPotential> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        IntraGroupLJFFBase_exposer.def( "__getstate_manages_dict__", true);
        IntraGroupLJFFBase_exposer.def( "__safe_for_unpickling__", true);
        IntraGroupLJFFBase_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::Intra2B2GFF<SireMM::LJPotentialInterface<SireMM::IntraLJPotential> > > );
        IntraGroupLJFFBase_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::Intra2B2GFF<SireMM::LJPotentialInterface<SireMM::IntraLJPotential> > > );
