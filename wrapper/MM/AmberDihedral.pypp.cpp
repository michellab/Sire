...
void register_AmberDihedral_class(){
    ...
    { //::SireMM::AmberDihedral
        ...
        AmberDihedral_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::AmberDihedral >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AmberDihedral_exposer.def( "__getstate_manages_dict__", true);
        AmberDihedral_exposer.def( "__safe_for_unpickling__", true);
        AmberDihedral_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::AmberDihedral > );
        AmberDihedral_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::AmberDihedral > );
