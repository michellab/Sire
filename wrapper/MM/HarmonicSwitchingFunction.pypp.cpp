...
void register_HarmonicSwitchingFunction_class(){
    ...
    { //::SireMM::HarmonicSwitchingFunction
        ...
        HarmonicSwitchingFunction_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::HarmonicSwitchingFunction >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        HarmonicSwitchingFunction_exposer.def( "__getstate_manages_dict__", true);
        HarmonicSwitchingFunction_exposer.def( "__safe_for_unpickling__", true);
        HarmonicSwitchingFunction_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::HarmonicSwitchingFunction > );
        HarmonicSwitchingFunction_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::HarmonicSwitchingFunction > );
