...
void register_UreyBradleyComponent_class(){
    ...
    { //::SireMM::UreyBradleyComponent
        ...
        UreyBradleyComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::UreyBradleyComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        UreyBradleyComponent_exposer.def( "__getstate_manages_dict__", true);
        UreyBradleyComponent_exposer.def( "__safe_for_unpickling__", true);
        UreyBradleyComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::UreyBradleyComponent > );
        UreyBradleyComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::UreyBradleyComponent > );
