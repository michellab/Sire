...
void register_InterSoftCLJFFBase_class(){
    ...
    { //::SireFF::Inter2BFF< SireMM::SoftCLJPotentialInterface< SireMM::InterSoftCLJPotential > >
        ...
        InterSoftCLJFFBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::Inter2BFF<SireMM::SoftCLJPotentialInterface<SireMM::InterSoftCLJPotential> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InterSoftCLJFFBase_exposer.def( "__getstate_manages_dict__", true);
        InterSoftCLJFFBase_exposer.def( "__safe_for_unpickling__", true);
        InterSoftCLJFFBase_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::Inter2BFF<SireMM::SoftCLJPotentialInterface<SireMM::InterSoftCLJPotential> > > );
        InterSoftCLJFFBase_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::Inter2BFF<SireMM::SoftCLJPotentialInterface<SireMM::InterSoftCLJPotential> > > );
