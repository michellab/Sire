...
void register_GromacsAtomType_class(){
    ...
    { //::SireMM::GromacsAtomType
        ...
        GromacsAtomType_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::GromacsAtomType >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GromacsAtomType_exposer.def( "__getstate_manages_dict__", true);
        GromacsAtomType_exposer.def( "__safe_for_unpickling__", true);
        GromacsAtomType_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::GromacsAtomType > );
        GromacsAtomType_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::GromacsAtomType > );
