...
void register_AtomPairs_CoulombScaleFactor__class(){
    ...
    { //::SireMM::AtomPairs< SireMM::CoulombScaleFactor >
        ...
        AtomPairs_CoulombScaleFactor__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::AtomPairs<SireMM::CoulombScaleFactor> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomPairs_CoulombScaleFactor__exposer.def( "__getstate_manages_dict__", true);
        AtomPairs_CoulombScaleFactor__exposer.def( "__safe_for_unpickling__", true);
        AtomPairs_CoulombScaleFactor__exposer.def( "__setstate__", &__setstate__base64< ::SireMM::AtomPairs<SireMM::CoulombScaleFactor> > );
        AtomPairs_CoulombScaleFactor__exposer.def( "__getstate__", &__getstate__base64< ::SireMM::AtomPairs<SireMM::CoulombScaleFactor> > );
