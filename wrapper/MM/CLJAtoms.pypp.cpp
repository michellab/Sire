...
void register_CLJAtoms_class(){
    ...
    { //::SireMM::CLJAtoms
        ...
        CLJAtoms_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::CLJAtoms >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CLJAtoms_exposer.def( "__getstate_manages_dict__", true);
        CLJAtoms_exposer.def( "__safe_for_unpickling__", true);
        CLJAtoms_exposer.def( "__setstate__", &__setstate__base64< ::SireMM::CLJAtoms > );
        CLJAtoms_exposer.def( "__getstate__", &__getstate__base64< ::SireMM::CLJAtoms > );
