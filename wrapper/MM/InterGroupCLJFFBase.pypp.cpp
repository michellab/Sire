...
void register_InterGroupCLJFFBase_class(){
    ...
    { //::SireFF::Inter2B2GFF< SireMM::CLJPotentialInterface< SireMM::InterCLJPotential > >
        ...
        InterGroupCLJFFBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::Inter2B2GFF<SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> > >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InterGroupCLJFFBase_exposer.def( "__getstate_manages_dict__", true);
        InterGroupCLJFFBase_exposer.def( "__safe_for_unpickling__", true);
        InterGroupCLJFFBase_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::Inter2B2GFF<SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> > > );
        InterGroupCLJFFBase_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::Inter2B2GFF<SireMM::CLJPotentialInterface<SireMM::InterCLJPotential> > > );
