...
void register_FFDetail_class(){
    ...
    { //::SireFF::FFDetail
        ...
        FFDetail_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::FFDetail >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        FFDetail_exposer.def( "__getstate_manages_dict__", true);
        FFDetail_exposer.def( "__safe_for_unpickling__", true);
        FFDetail_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::FFDetail > );
        FFDetail_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::FFDetail > );
