...
void register_Point_class(){
    ...
    { //::SireFF::Point
        ...
        Point_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::Point >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Point_exposer.def( "__getstate_manages_dict__", true);
        Point_exposer.def( "__safe_for_unpickling__", true);
        Point_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::Point > );
        Point_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::Point > );
