...
void register_FFName_class(){
    ...
    { //::SireFF::FFName
        ...
        FFName_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::FFName >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        FFName_exposer.def( "__getstate_manages_dict__", true);
        FFName_exposer.def( "__safe_for_unpickling__", true);
        FFName_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::FFName > );
        FFName_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::FFName > );
