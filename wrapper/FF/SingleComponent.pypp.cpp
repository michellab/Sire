...
void register_SingleComponent_class(){
    ...
    { //::SireFF::SingleComponent
        ...
        SingleComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::SingleComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SingleComponent_exposer.def( "__getstate_manages_dict__", true);
        SingleComponent_exposer.def( "__safe_for_unpickling__", true);
        SingleComponent_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::SingleComponent > );
        SingleComponent_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::SingleComponent > );
