...
void register_G1FF_class(){
    ...
    { //::SireFF::G1FF
        ...
        G1FF_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::G1FF >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        G1FF_exposer.def( "__getstate_manages_dict__", true);
        G1FF_exposer.def( "__safe_for_unpickling__", true);
        G1FF_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::G1FF > );
        G1FF_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::G1FF > );
