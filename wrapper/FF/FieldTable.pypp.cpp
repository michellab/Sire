...
void register_FieldTable_class(){
    ...
    { //::SireFF::FieldTable
        ...
        FieldTable_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::FieldTable >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        FieldTable_exposer.def( "__getstate_manages_dict__", true);
        FieldTable_exposer.def( "__safe_for_unpickling__", true);
        FieldTable_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::FieldTable > );
        FieldTable_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::FieldTable > );
