...
void register_GridPotentialTable_class(){
    ...
    { //::SireFF::GridPotentialTable
        ...
        GridPotentialTable_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::GridPotentialTable >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        GridPotentialTable_exposer.def( "__getstate_manages_dict__", true);
        GridPotentialTable_exposer.def( "__safe_for_unpickling__", true);
        GridPotentialTable_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::GridPotentialTable > );
        GridPotentialTable_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::GridPotentialTable > );
