...
void register_MolFieldTable_class(){
    ...
    { //::SireFF::MolFieldTable
        ...
        MolFieldTable_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::MolFieldTable >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        MolFieldTable_exposer.def( "__getstate_manages_dict__", true);
        MolFieldTable_exposer.def( "__safe_for_unpickling__", true);
        MolFieldTable_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::MolFieldTable > );
        MolFieldTable_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::MolFieldTable > );
