...
void register_NullProbe_class(){
    ...
    { //::SireFF::NullProbe
        ...
        NullProbe_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireFF::NullProbe >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        NullProbe_exposer.def( "__getstate_manages_dict__", true);
        NullProbe_exposer.def( "__safe_for_unpickling__", true);
        NullProbe_exposer.def( "__setstate__", &__setstate__base64< ::SireFF::NullProbe > );
        NullProbe_exposer.def( "__getstate__", &__getstate__base64< ::SireFF::NullProbe > );
