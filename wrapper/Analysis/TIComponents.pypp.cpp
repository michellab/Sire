...
void register_TIComponents_class(){
    ...
    { //::SireAnalysis::TIComponents
        ...
        TIComponents_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireAnalysis::TIComponents >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        TIComponents_exposer.def( "__getstate_manages_dict__", true);
        TIComponents_exposer.def( "__safe_for_unpickling__", true);
        TIComponents_exposer.def( "__setstate__", &__setstate__base64< ::SireAnalysis::TIComponents > );
        TIComponents_exposer.def( "__getstate__", &__getstate__base64< ::SireAnalysis::TIComponents > );
