...
void register_Gradients_class(){
    ...
    { //::SireAnalysis::Gradients
        ...
        Gradients_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireAnalysis::Gradients >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Gradients_exposer.def( "__getstate_manages_dict__", true);
        Gradients_exposer.def( "__safe_for_unpickling__", true);
        Gradients_exposer.def( "__setstate__", &__setstate__base64< ::SireAnalysis::Gradients > );
        Gradients_exposer.def( "__getstate__", &__getstate__base64< ::SireAnalysis::Gradients > );
