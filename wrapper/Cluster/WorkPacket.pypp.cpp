...
void register_WorkPacket_class(){
    ...
    { //::SireCluster::WorkPacket
        ...
        WorkPacket_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCluster::WorkPacket >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        WorkPacket_exposer.def( "__getstate_manages_dict__", true);
        WorkPacket_exposer.def( "__safe_for_unpickling__", true);
        WorkPacket_exposer.def( "__setstate__", &__setstate__base64< ::SireCluster::WorkPacket > );
        WorkPacket_exposer.def( "__getstate__", &__getstate__base64< ::SireCluster::WorkPacket > );
