...
void register_WorkPacketBase_class(){
    ...
    { //::SireCluster::WorkPacketBase
        ...
        WorkPacketBase_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCluster::WorkPacketBase >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        WorkPacketBase_exposer.def( "__getstate_manages_dict__", true);
        WorkPacketBase_exposer.def( "__safe_for_unpickling__", true);
        WorkPacketBase_exposer.def( "__setstate__", &__setstate__base64< ::SireCluster::WorkPacketBase > );
        WorkPacketBase_exposer.def( "__getstate__", &__getstate__base64< ::SireCluster::WorkPacketBase > );
