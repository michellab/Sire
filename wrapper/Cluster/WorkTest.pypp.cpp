...
void register_WorkTest_class(){
    ...
    { //::SireCluster::WorkTest
        ...
        WorkTest_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCluster::WorkTest >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        WorkTest_exposer.def( "__getstate_manages_dict__", true);
        WorkTest_exposer.def( "__safe_for_unpickling__", true);
        WorkTest_exposer.def( "__setstate__", &__setstate__base64< ::SireCluster::WorkTest > );
        WorkTest_exposer.def( "__getstate__", &__getstate__base64< ::SireCluster::WorkTest > );
