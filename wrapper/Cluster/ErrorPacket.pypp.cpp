...
void register_ErrorPacket_class(){
    ...
    { //::SireCluster::ErrorPacket
        ...
        ErrorPacket_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireCluster::ErrorPacket >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        ErrorPacket_exposer.def( "__getstate_manages_dict__", true);
        ErrorPacket_exposer.def( "__safe_for_unpickling__", true);
        ErrorPacket_exposer.def( "__setstate__", &__setstate__base64< ::SireCluster::ErrorPacket > );
        ErrorPacket_exposer.def( "__getstate__", &__getstate__base64< ::SireCluster::ErrorPacket > );
