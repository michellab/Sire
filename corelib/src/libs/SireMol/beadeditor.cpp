...
QDataStream SIREMOL_EXPORT &operator<<(QDataStream &ds, const BeadEditor &beadeditor)
{
...
QDataStream SIREMOL_EXPORT &operator>>(QDataStream &ds, BeadEditor &beadeditor)
{
