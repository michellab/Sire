...
QDataStream SIREMOVE_EXPORT &operator<<(QDataStream &ds, const OpenMMFrEnergyST &velver)
{
    ...
    sds << velver.frequent_save_velocities << velver.molgroup << velver.solute
        ...
        << velver.CombRules << velver.combining_rules
...
QDataStream SIREMOVE_EXPORT &operator>>(QDataStream &ds, OpenMMFrEnergyST &velver)
{
    ...
    if (v == 1)
    {
        ...
        sds >> velver.frequent_save_velocities >> velver.molgroup
            ...
            >> velver.solutefromdummy >> velver.CombRules >> velver.combining_rules 
...
openmm_system(0), openmm_context(0), isSystemInitialised(false), isContextInitialised(false), CombRules("arithmetic"),
...
isContextInitialised(other.isContextInitialised), CombRules(other.CombRules),
