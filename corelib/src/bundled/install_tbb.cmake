...
if ( MSYS )
  ...
  message( STATUS "Looking for conda TBB in ${SIRE_APP}/lib" )
  find_library( TBB_LIBRARY "tbb" PATHS "${SIRE_APP}/lib" NO_DEFAULT_PATH )
  find_library( TBB_MALLOC_LIBRARY "tbbmalloc" PATHS "${SIRE_APP}/lib" NO_DEFAULT_PATH )
endif()

if ( TBB_LIBRARY AND TBB_MALLOC_LIBRARY )
  message( STATUS "Have already compiled a bundled version of TBB" )
  set( TBB_INCLUDE_DIR "${SIRE_APP}/include" )
else() 
