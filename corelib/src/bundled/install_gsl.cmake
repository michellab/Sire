...
if ( MSYS )
  ...
  find_library( GSL_LIBRARY "gsl" PATHS ${SIRE_APP}/lib NO_DEFAULT_PATH )
  find_library( GSL_CBLAS_LIBRARY "gslcblas" PATHS ${SIRE_APP}/lib NO_DEFAULT_PATH )
endif()
...
if ( GSL_LIBRARY )
  ...
  set( GSL_INCLUDE_DIR "${SIRE_APP}/include")
